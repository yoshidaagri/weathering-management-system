...
const PlanActualDashboard: React.FC = () => {
  // 表示期間の選択状態
          ...
          <div className="flex gap-3">
            ...
            >
              <Select.Trigger className="w-40">
                <Select.Value placeholder="表示期間" />
              </Select.Trigger>
              <Select.Content>
                <Select.Item value="monthly">月次表示</Select.Item>
                <Select.Item value="quarterly">四半期表示</Select.Item>
                <Select.Item value="yearly">年次表示</Select.Item>
              </Select.Content>
            </Select>
        ...
        <Card className="p-6">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full">
              ...
              <tbody>
                {co2FixationData.reverse().slice(0, 3).map((data, index) => (
